// 注：因为屏幕素质不一，SPI频率过高可能会导致显示异常，如花屏、闪烁等
// 在使用内置字体的情况下全屏幕刷新约30-48FPS
// 频率设置为80MHz,上述情况下约65-67FPS
// 适配ESP32C3的160MHz CPU频率，SPI频率设置为48MHz 5/3分频
// 适配ESP32S3的240MHz CPU频率，SPI频率设置为64MHz 5/4分频
// 不建议超过64MHz的频率
// SPI频率对于启动速度影响不大，主要影响屏幕刷新率
